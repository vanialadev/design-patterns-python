...
class Nota_fiscal(object):
    ...
    def mostra(self):
        print(self.__razao_social, self.__cnpj, self.__data_de_emissao, self.__detalhes)
...
if __name__ == '__main__':
    ...
    nota_fiscal_criada_com_o_builder = (Criador_de_nota_fiscal()
                                        .com_razao_social('FHSA Limitada')
                                        .com_cnpj('01234567r8901234')
                                        .com_itens(itens)
                                        .constroi()

    )

    nota_fiscal_criada_com_o_builder.mostra()
